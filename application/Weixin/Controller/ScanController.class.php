...
class ScanController extends IndexController {
	...
	public function success_pay() {
		...
		$t_info = $true_order_model->field('tos.c_time')->table ( "cw_turn_order as tos" )->join ( "cw_order as o on o.id=tos.order_id", 'left' )->join ( "cw_services as s on s.id=o.services_id", 'left' )->where ( "o.order_sn='$order_sn'" )->find ();
